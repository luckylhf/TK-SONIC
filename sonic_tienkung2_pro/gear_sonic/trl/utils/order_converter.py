...
class Tienkung2ProConverter(IsaacLabMuJoCoConverter):
    """Tienkung2 Pro joint/body order converter between IsaacLab and MuJoCo."""

    def __init__(self):
        from gear_sonic.envs.manager_env.robots.tienkung2_pro import (
        ...
        self.JOINT_NAMES = TIENKUNG2_PRO_ISAACLAB_JOINTS
        self.DOF_MAPPINGS = {
            ("isaaclab", "mujoco"): TIENKUNG2_PRO_ISAACLAB_TO_MUJOCO_DOF,
            ("mujoco", "isaaclab"): TIENKUNG2_PRO_MUJOCO_TO_ISAACLAB_DOF,
        }
        self.BODY_MAPPINGS = {
            ("isaaclab", "mujoco"): TIENKUNG2_PRO_ISAACLAB_TO_MUJOCO_BODY,
            ("mujoco", "isaaclab"): TIENKUNG2_PRO_MUJOCO_TO_ISAACLAB_BODY,
        }

    # Tienkung2 Pro: wrist_roll is the distal wrist body (no wrist_yaw joint)
    VR_3POINTS_BODY_NAMES = ["body_yaw_link", "wrist_roll_l_link", "wrist_roll_r_link"]
