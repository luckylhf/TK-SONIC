"""Entry point for running a MuJoCo simulation loop with G1 or TienKung2 Pro.

Parses a YAML-based WBC config via tyro CLI, instantiates the robot model,
...
from gear_sonic.data.robot_model.instantiation.tienkung2_pro import (
...
def main(config: ArgsConfig):
    ...
    if config.wbc_version == "tienkung2_pro_sonic":
        robot_model = instantiate_tienkung2_pro_robot_model()
    else:
