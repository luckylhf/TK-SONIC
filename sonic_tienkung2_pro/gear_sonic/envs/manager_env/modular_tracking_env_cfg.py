...
from gear_sonic.envs.manager_env.robots import g1, h2, tienkung2_pro
...
class ModularTrackingEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def override_settings(self):
        ...
        robot_mapping = {
            ...
            "tienkung2_pro": {
                "robot_cfg": tienkung2_pro.TIENKUNG2_PRO_CFG,
                "action_scale": tienkung2_pro.TIENKUNG2_PRO_ACTION_SCALE_TRACKING,
                "isaaclab_to_mujoco_mapping": tienkung2_pro.TIENKUNG2_PRO_ISAACLAB_TO_MUJOCO_MAPPING,
            },
        }
