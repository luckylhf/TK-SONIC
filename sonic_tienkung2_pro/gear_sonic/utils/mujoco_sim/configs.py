...
WBC_VERSIONS = ["sonic_model12", "tienkung2_pro_sonic"]
...
class BaseConfig(ArgsConfigTemplate):
    ...
    def load_wbc_yaml(self) -> dict:
        ...
        elif self.wbc_version == "tienkung2_pro_sonic":
            config_path = str(configs_dir / "tienkung2_pro_sonic.yaml")
        else:
            raise ValueError(
                f"Invalid wbc_version: {self.wbc_version}, please use one of: "
                f"sonic_model12, tienkung2_pro_sonic"
            )
