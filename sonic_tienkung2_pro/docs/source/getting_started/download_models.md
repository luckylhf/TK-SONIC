...
A small sample dataset is not included in this clean source package. If your
BONES-SEED authorization permits access to the NVIDIA-hosted sample, download it
separately after reviewing and accepting the applicable terms. The sample contains
the three data types needed for training: robot retargeted, SOMA skeleton, and
SMPL.
