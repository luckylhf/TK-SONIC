...
.. image:: https://img.shields.io/badge/License-Multiple-blue.svg
...
Welcome to the downstream SONIC TienKung2 Pro documentation based on **GR00T
Whole-Body Control (WBC)**. This package adapts the upstream platform for
TienKung2 Pro.
...
- **[2026-03-16]** `BONES-SEED <https://huggingface.co/datasets/bones-studio/seed>`_ published under a gated custom license — 142K+ human motions (~288 hours) with G1 MuJoCo trajectories.
