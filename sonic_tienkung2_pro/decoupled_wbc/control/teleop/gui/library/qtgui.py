...
# Derived from MakeHuman makehuman/lib/qtgui.py.
# Copyright (c) MakeHuman Team 2001-2020.
# Modified before 2026-08-18 for PyQt6 and SONIC integration; the exact
# historical modification date is unavailable in the source package.
# Compliance metadata added by luckylhf on 2026-08-18.
